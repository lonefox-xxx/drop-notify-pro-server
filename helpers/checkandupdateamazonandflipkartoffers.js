...
function genarateNotificationMessage(attributes, url, linkPlaceHolder) {
    try {
        ...
        const lootDealText = "The product is now at its lowest price ever, making a perfect time to buy🔥"
        const hotDealText = `The price is now${lowestprice != deal && ' almost'} same as its all-time low of ${lowestprice}. Sounds a great deal😘`
